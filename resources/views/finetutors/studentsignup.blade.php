...
@section('content')
   ...
   <header class="masthead">
      <div class="container">
        <div class="intro-text">
          <div class="intro-lead-in">Register as Guardian in order to creat a tuition post</div>     
    <div class="container">
   <form class="form-horizontal" action="/action_page.php" id="signinForm">
     ...
     <div class="form-group">
      ...
      <div class="form-group">
       <div class="col-sm-10">          
         <input type="text" class="form-control" id="phone" placeholder="Enter phone" name="phonne">
       </div>
     </div>
     ...
     <div class="form-group">        
       <div class="col-sm-offset-3 col-sm-9">
         <div class="checkbox">
           <label><input type="checkbox" name="remember" required>By checking this checkbox i agree to the privacy policy.</label>
         </div>
       </div>
     </div>
